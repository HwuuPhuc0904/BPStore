...
import ProductFilter from "../Slidebar/ProductFilter";
...
export default function ProductGrid() {
    ...
    useEffect(() => {
                    ...
                    sortOption === "popular"
                        ...
                        : sortOption === "newest"
                            ...
                            : sortOption === "best-selling"
                                ...
                                : sortOption === "price"
                                    ? `sort=price&order=${priceSortOrder}`
                                    : "";

                if (selectedCategory) {
                    apiUrlWithParams = `${API_URL}/category/${selectedCategory}?page=${currentPage}&limit=20&${sortParams}`;
                } else {
                    apiUrlWithParams = `${API_URL}?page=${currentPage}&limit=20&${sortParams}`;
                }
        ...
        fetchProducts();
    }, [currentPage, selectedCategory, sortOption, priceSortOrder]);
    ...
    const handleFilterChange = (filters) => {
        const { price, rating, brand, promo, category } = filters;
        setSelectedCategory(category);
        setCurrentPage(1);
    };

    return (
        <div className="p-6 bg-gray-100 min-h-screen overflow-y-auto flex">
            {/* Sidebar Filter */}
